...
/**
 * A processor that will get updated whenever an event in [ ] happens. This gets triggered for
 * specific [ChatMessage].
 */
interface IChatMessageProcessor {
	...
	/**
	 * A method to handle a [ChatMessage] update.
	 *
	 * @param message Message that was updated
	 * @param type Type of the update
	 */
	fun onMessageUpdate(message: ChatMessage?, type: UpdateType?)
}
